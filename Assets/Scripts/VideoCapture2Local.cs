...
public class VideoCapture2Local : MonoBehaviour
{
    ...
    public float remainDistance = 1000000;
    ...
    void Start()
    {
        Debug.Log("record start test");
    }

    void Upload()
    {
        Debug.Log("record test");
        // remainDistance = GetPosition.GetCurrentExitDistance();
        ...
        //     });
        // }
        // else if (m_VideoCapture.IsRecording && remainDistance < 0.5)
        // {
        ...
        {
            Debug.Log("Controller Button is clicked.");
            OnClickPlayButton();
        }
